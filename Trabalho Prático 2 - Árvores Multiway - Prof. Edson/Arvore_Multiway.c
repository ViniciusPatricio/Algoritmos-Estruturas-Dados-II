        ...
        // caso a chave nao esta no nó
            ...
            if(auxiliar->num_chaves==MIN){
                ...
                if(esq != NULL && esq->num_chaves>MIN){
                    ...
                    int chave_sobe = esq->chaves[posicao-1];
...
int main(){
    ...
    for(int i = 0; i<300; i++){   // inserindo 300 numeros aleatórios de 0 a 1000
        int num = rand()%1000;
